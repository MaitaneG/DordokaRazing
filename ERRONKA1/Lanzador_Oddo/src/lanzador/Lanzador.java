...
public class Lanzador {
	/**
	 * Metodo honek processBuilder objetuak gauzatzen ditu bidalitako bi
	 * parametroekin
	 * 
	...
	public void lanzarOddo(String url, char c) {
		...
		try {
			...
			pb = new ProcessBuilder("java.exe", "-cp", directory, "lanzador.Navegador", url, Character.toString(c)); // prozesu
																														// berri
																														// bat
																														// proiektuko
																														// beste
